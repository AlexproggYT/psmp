...
public class WeurmEntity extends TamableAnimal {
	public WeurmEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PookieModEntities.WEURM.get(), world);
	}

	public WeurmEntity(EntityType<WeurmEntity> type, Level world) {
		super(type, world);
		maxUpStep = 2.6f;
		xpReward = 25;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		WeurmEntity retval = PookieModEntities.WEURM.get().create(serverWorld);
