...
public class AlbinowomEntity extends TamableAnimal {
	public AlbinowomEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PookieModEntities.ALBINOWOM.get(), world);
	}

	public AlbinowomEntity(EntityType<AlbinowomEntity> type, Level world) {
		super(type, world);
		maxUpStep = 2.6f;
		xpReward = 25;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		AlbinowomEntity retval = PookieModEntities.ALBINOWOM.get().create(serverWorld);
