...
public class BlueweurmEntity extends TamableAnimal {
	public BlueweurmEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PookieModEntities.BLUEWEURM.get(), world);
	}

	public BlueweurmEntity(EntityType<BlueweurmEntity> type, Level world) {
		super(type, world);
		maxUpStep = 2.6f;
		xpReward = 25;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		BlueweurmEntity retval = PookieModEntities.BLUEWEURM.get().create(serverWorld);
