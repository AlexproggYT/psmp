...
public class GreenweurmEntity extends TamableAnimal {
	public GreenweurmEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PookieModEntities.GREENWEURM.get(), world);
	}

	public GreenweurmEntity(EntityType<GreenweurmEntity> type, Level world) {
		super(type, world);
		maxUpStep = 2.6f;
		xpReward = 25;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		GreenweurmEntity retval = PookieModEntities.GREENWEURM.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return List.of(PookieModItems.ONION.get(), PookieModItems.STRAWBERRYCHUNK.get(), PookieModItems.BAGUETTE.get(), Items.STRING).contains(stack.getItem());
	}
