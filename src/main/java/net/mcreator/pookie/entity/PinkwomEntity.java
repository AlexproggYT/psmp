...
public class PinkwomEntity extends TamableAnimal {
	public PinkwomEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PookieModEntities.PINKWOM.get(), world);
	}

	public PinkwomEntity(EntityType<PinkwomEntity> type, Level world) {
		super(type, world);
		maxUpStep = 2.6f;
		xpReward = 50;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		PinkwomEntity retval = PookieModEntities.PINKWOM.get().create(serverWorld);
